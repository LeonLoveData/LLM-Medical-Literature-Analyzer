llm_extract = ChatGroq(model="llama-3.1-8b-instant", temperature=0, groq_api_key=GROQ_API_KEY)
...
"""
extract_prompt = PromptTemplate(input_variables=["text","source_id"], template=STRICT_TEMPLATE)
...
def extract_record(text, source_id):
    ...
    try:
        ...
        return {"source_id": source_id, "error":"JSON_PARSE_FAILED","raw_output":res.content}
