llm_comp = ChatGroq(model="llama-3.1-8b-instant", temperature=0, groq_api_key=GROQ_API_KEY)
...
{summaries}
"""
comp_prompt = PromptTemplate(input_variables=["summaries"], template=COMP_TEMPLATE)
